...
# Load the model
model = load_model('final_mobilenet_model.keras')
...
@app.route('/')
def home():
    # Redirect to login page if not logged in, otherwise to index
...
def register():
    if request.method == 'POST':
        ...
        # Show success message on register page before redirect
